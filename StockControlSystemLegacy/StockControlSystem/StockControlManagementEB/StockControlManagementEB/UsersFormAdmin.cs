...
namespace StockControlManagementEB
{
    public partial class UsersFormAdmin : Form
    {
        ...
        private void btnViewUsers_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM LoginDetails", con); //This works
                con.Open();
        ...
        private void btnAddUser_Click(object sender, EventArgs e)
        {
            ...
            //Patch work for new database
            if (cmbAdmin.Text == "Yes")
            {
                adminAccess = "1";
            }
            else if (cmbAdmin.Text == "No")
            {
                adminAccess = "0";
            }
            ...
            try
            {
                ...
                {
                    SqlCommand sda = new SqlCommand("INSERT INTO LoginDetails VALUES ('" + username + "','" + password + "','" + adminAccess + "')", con); //This works
                    con.Open();
        ...
        private void btnDeleteUser_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sda = new SqlCommand("DELETE FROM LoginDetails WHERE Username = '" + username + "'", con); //This works
                    con.Open();
