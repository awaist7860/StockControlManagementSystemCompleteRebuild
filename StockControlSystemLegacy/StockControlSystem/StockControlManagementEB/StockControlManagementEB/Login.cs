    ...
    public partial class Login : Form
    {
        ...
        public void nextPageCheck()
        {
            ...
            try
            {
                ...
                con.Open();
                SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM TestDB.dbo.LoginDetails WHERE username = '" + txtUserName.Text + "' AND password = '" + txtPassword.Text + "' AND adminAccess = '1'", con);
                con.Close();
                con.Open();
                SqlDataAdapter sda2 = new SqlDataAdapter("SELECT * FROM TestDB.dbo.LoginDetails WHERE username = '" + txtUserName.Text + "' AND password = '" + txtPassword.Text + "' AND adminAccess = '0'", con);
                con.Close();
